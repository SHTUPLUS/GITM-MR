...
from .lr_scheduler import WarmupCosineLR, WarmupMultiStepLR, ReduceLROnPlateau
...
def build_optimizer(cfg: CfgNode, model: torch.nn.Module) -> torch.optim.Optimizer:
    ...
    else: raise NotImplementedError('only sgd,adam,adamw supported currently')
...
def build_lr_scheduler(
    cfg: CfgNode, optimizer: torch.optim.Optimizer
) -> object: #MODIFIED: torch.optim.lr_scheduler._LRScheduler:
    """
    ...
    elif name == "ReduceLROnPlateau": # MODIFIED
        return ReduceLROnPlateau(optimizer,
                                 factor=cfg.SOLVER.REDUCE_FACTOR,
                                 patience=cfg.SOLVER.REDUCE_LR_PATIENCE,
                                 mode=cfg.SOLVER.REDUCE_LR_MODE)
    else:
